...
/datum/mutation_upgrade/defense/little_more/get_desc_for_alert(new_amount)
	if(!new_amount)
		return ..()
	return "Endure further decreases your critical and death threshold by [-get_threshold(new_amount)]."

/datum/mutation_upgrade/defense/little_more/on_gain()
	. = ..()
...
/datum/mutation_upgrade/defense/little_more/on_loss()
	. = ..()
	var/datum/action/ability/xeno_action/endure/endure_ability = xenomorph_owner.actions_by_path[/datum/action/ability/xeno_action/endure]
	if(!endure_ability)
		return
...
/datum/mutation_upgrade/defense/little_more/on_structure_update(previous_amount, new_amount)
	. = ..()
	var/datum/action/ability/xeno_action/endure/endure_ability = xenomorph_owner.actions_by_path[/datum/action/ability/xeno_action/endure]
	if(!endure_ability)
		return
...
/datum/mutation_upgrade/defense/little_more/proc/get_threshold(structure_count, include_initial = TRUE)
...
/datum/mutation_upgrade/defense/keep_going/get_desc_for_alert(new_amount)
	if(!new_amount)
		return ..()
...
/datum/mutation_upgrade/defense/keep_going/on_gain()
	. = ..()
	var/datum/action/ability/xeno_action/endure/endure_ability = xenomorph_owner.actions_by_path[/datum/action/ability/xeno_action/endure]
	if(!endure_ability)
		return
...
/datum/mutation_upgrade/defense/keep_going/on_loss()
	. = ..()
	var/datum/action/ability/xeno_action/endure/endure_ability = xenomorph_owner.actions_by_path[/datum/action/ability/xeno_action/endure]
	if(!endure_ability)
		return
...
/datum/mutation_upgrade/defense/keep_going/on_structure_update(previous_amount, new_amount)
	. = ..()
	var/datum/action/ability/xeno_action/endure/endure_ability = xenomorph_owner.actions_by_path[/datum/action/ability/xeno_action/endure]
	if(!endure_ability)
		return
...
/datum/mutation_upgrade/defense/keep_going/proc/get_multiplier(structure_count, include_initial = TRUE)
...
/datum/mutation_upgrade/defense/inward_focus/get_desc_for_alert(new_amount)
	if(!new_amount)
		return ..()
...
/datum/mutation_upgrade/defense/inward_focus/on_gain()
	. = ..()
	var/datum/action/ability/xeno_action/endure/endure_ability = xenomorph_owner.actions_by_path[/datum/action/ability/xeno_action/endure]
	if(!endure_ability)
		return
...
/datum/mutation_upgrade/defense/inward_focus/on_loss()
	. = ..()
	var/datum/action/ability/xeno_action/endure/endure_ability = xenomorph_owner.actions_by_path[/datum/action/ability/xeno_action/endure]
	if(!endure_ability)
		return
...
/datum/mutation_upgrade/defense/inward_focus/on_structure_update(previous_amount, new_amount)
	. = ..()
	var/datum/action/ability/xeno_action/endure/endure_ability = xenomorph_owner.actions_by_path[/datum/action/ability/xeno_action/endure]
	if(!endure_ability)
		return
...
/datum/mutation_upgrade/defense/inward_focus/proc/get_armor(structure_count, include_initial = TRUE)
...
/datum/mutation_upgrade/offense/deep_slash/get_desc_for_alert(new_amount)
	if(!new_amount)
		return ..()
	return "Ravage now has an additional [get_ap(new_amount)] armor penetration."

/datum/mutation_upgrade/offense/deep_slash/on_gain()
	. = ..()
...
/datum/mutation_upgrade/offense/deep_slash/on_loss()
	. = ..()
	var/datum/action/ability/activable/xeno/ravage/ravage_ability = xenomorph_owner.actions_by_path[/datum/action/ability/activable/xeno/ravage]
	if(!ravage_ability)
		return
...
/datum/mutation_upgrade/offense/deep_slash/on_structure_update(previous_amount, new_amount)
	. = ..()
	var/datum/action/ability/activable/xeno/ravage/ravage_ability = xenomorph_owner.actions_by_path[/datum/action/ability/activable/xeno/ravage]
	if(!ravage_ability)
		return
...
/datum/mutation_upgrade/offense/deep_slash/proc/get_ap(structure_count, include_initial = TRUE)
...
/datum/mutation_upgrade/offense/super_cut/get_desc_for_alert(new_amount)
	if(!new_amount)
		return ..()
	return "Ravage now slashes in all directions, but has a cast time of [get_time(new_amount) / 10] seconds."

/datum/mutation_upgrade/offense/super_cut/on_gain()
	. = ..()
	var/datum/action/ability/activable/xeno/ravage/ravage_ability = xenomorph_owner.actions_by_path[/datum/action/ability/activable/xeno/ravage]
	if(!ravage_ability)
		return
...
/datum/mutation_upgrade/offense/super_cut/on_loss()
	. = ..()
	var/datum/action/ability/activable/xeno/ravage/ravage_ability = xenomorph_owner.actions_by_path[/datum/action/ability/activable/xeno/ravage]
	if(!ravage_ability)
		return
...
/datum/mutation_upgrade/offense/super_cut/on_structure_update(previous_amount, new_amount)
	. = ..()
	var/datum/action/ability/activable/xeno/ravage/ravage_ability = xenomorph_owner.actions_by_path[/datum/action/ability/activable/xeno/ravage]
	if(!ravage_ability)
		return
...
/datum/mutation_upgrade/offense/super_cut/proc/get_time(structure_count, include_initial = TRUE)
...
/datum/mutation_upgrade/offense/onslaught/get_desc_for_alert(new_amount)
	if(!new_amount)
		return ..()
...
/datum/mutation_upgrade/offense/onslaught/on_gain()
	. = ..()
...
/datum/mutation_upgrade/offense/onslaught/on_loss()
	. = ..()
	var/datum/action/ability/activable/xeno/charge/charge_ability = xenomorph_owner.actions_by_path[/datum/action/ability/activable/xeno/charge]
	if(!charge_ability)
		return
...
/datum/mutation_upgrade/offense/onslaught/on_structure_update(previous_amount, new_amount)
	. = ..()
	var/datum/action/ability/activable/xeno/charge/charge_ability = xenomorph_owner.actions_by_path[/datum/action/ability/activable/xeno/charge]
	if(!charge_ability)
		return
...
/datum/mutation_upgrade/offense/onslaught/proc/get_multiplier(structure_count, include_initial = TRUE)
	return (include_initial ? multiplier_initial : 0) + (multiplier_per_structure * structure_count)
...
/datum/mutation_upgrade/utility/recurring_rage/get_desc_for_alert(new_amount)
	if(!new_amount)
		return ..()
...
/datum/mutation_upgrade/utility/recurring_rage/on_gain()
	. = ..()
	var/datum/action/ability/xeno_action/rage/rage_ability = xenomorph_owner.actions_by_path[/datum/action/ability/xeno_action/rage]
	if(!rage_ability)
		return
...
/datum/mutation_upgrade/utility/recurring_rage/on_loss()
	. = ..()
	var/datum/action/ability/xeno_action/rage/rage_ability = xenomorph_owner.actions_by_path[/datum/action/ability/xeno_action/rage]
	if(!rage_ability)
		return
...
/datum/mutation_upgrade/utility/recurring_rage/on_structure_update(previous_amount, new_amount)
	. = ..()
	var/datum/action/ability/xeno_action/rage/rage_ability = xenomorph_owner.actions_by_path[/datum/action/ability/xeno_action/rage]
	if(!rage_ability)
		return
...
/datum/mutation_upgrade/utility/recurring_rage/proc/get_multiplier(structure_count, include_initial = TRUE)
	return (include_initial ? multiplier_initial : 0) + (multiplier_per_structure * structure_count)

/// Checks if Rage can be activated. If so, activate it.
/datum/mutation_upgrade/utility/recurring_rage/proc/on_update_health()
	SIGNAL_HANDLER
...
/datum/mutation_upgrade/utility/fight_in_flames/get_desc_for_alert(new_amount)
	if(!new_amount)
		return ..()
...
/datum/mutation_upgrade/utility/fight_in_flames/on_gain()
	. = ..()
...
/datum/mutation_upgrade/utility/fight_in_flames/on_loss()
	. = ..()
	if(!isxenoravager(xenomorph_owner))
		return
...
/datum/mutation_upgrade/utility/fight_in_flames/on_structure_update(previous_amount, new_amount)
	. = ..()
	if(!isxenoravager(xenomorph_owner))
		return
	var/mob/living/carbon/xenomorph/ravager/ravager_owner = xenomorph_owner
...
/datum/mutation_upgrade/utility/fight_in_flames/proc/get_plasma(structure_count, include_initial = TRUE)
...
/datum/mutation_upgrade/utility/fight_in_flames/proc/on_handle_fire(datum/source)
...
/datum/mutation_upgrade/utility/bloody_endure/get_desc_for_alert(new_amount)
	if(!new_amount)
		return ..()
...
/datum/mutation_upgrade/utility/bloody_endure/on_gain()
	. = ..()
	var/datum/action/ability/xeno_action/endure/endure_ability = xenomorph_owner.actions_by_path[/datum/action/ability/xeno_action/endure]
	if(!endure_ability)
		return
...
/datum/mutation_upgrade/utility/bloody_endure/on_loss()
	. = ..()
	var/datum/action/ability/xeno_action/endure/endure_ability = xenomorph_owner.actions_by_path[/datum/action/ability/xeno_action/endure]
	if(!endure_ability)
		return
...
/datum/mutation_upgrade/utility/bloody_endure/on_structure_update(previous_amount, new_amount)
	. = ..()
	var/datum/action/ability/xeno_action/endure/endure_ability = xenomorph_owner.actions_by_path[/datum/action/ability/xeno_action/endure]
	if(!endure_ability)
		return
...
/datum/mutation_upgrade/utility/bloody_endure/proc/get_multiplier(structure_count, include_initial = TRUE)
	return (include_initial ? multiplier_initial : 0) + (multiplier_per_structure * structure_count)

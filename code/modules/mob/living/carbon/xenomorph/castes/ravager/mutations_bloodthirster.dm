...
/datum/mutation_upgrade/defense/no_end/on_loss()
	. = ..()
	var/datum/action/ability/xeno_action/endure/endure_ability = xenomorph_owner.actions_by_path[/datum/action/ability/xeno_action/endure]
	if(!endure_ability)
		return
...
/datum/mutation_upgrade/defense/no_end/on_structure_update(previous_amount, new_amount)
	. = ..()
	var/datum/action/ability/xeno_action/endure/endure_ability = xenomorph_owner.actions_by_path[/datum/action/ability/xeno_action/endure]
	if(!endure_ability)
		return
...
/datum/mutation_upgrade/defense/no_end/proc/get_multiplier(structure_count, include_initial = TRUE)
...
/datum/mutation_upgrade/offense/early_rage/get_desc_for_alert(new_amount)
	if(!new_amount)
		return ..()
...
/datum/mutation_upgrade/offense/early_rage/on_structure_update(previous_amount, new_amount)
	. = ..()
...
/datum/mutation_upgrade/offense/early_rage/proc/get_percentage(structure_count)
...
/datum/mutation_upgrade/utility/safety_trap/get_desc_for_alert(new_amount)
	if(!new_amount)
		return ..()
...
/datum/mutation_upgrade/utility/safety_trap/on_gain()
	. = ..()
	var/datum/action/ability/xeno_action/endure/endure_ability = xenomorph_owner.actions_by_path[/datum/action/ability/xeno_action/endure]
	if(!endure_ability)
		return
...
/datum/mutation_upgrade/utility/safety_trap/on_loss()
	. = ..()
	var/datum/action/ability/xeno_action/endure/endure_ability = xenomorph_owner.actions_by_path[/datum/action/ability/xeno_action/endure]
	if(!endure_ability)
		return
...
/datum/mutation_upgrade/utility/safety_trap/on_structure_update(previous_amount, new_amount)
	. = ..()
	var/datum/action/ability/xeno_action/endure/endure_ability = xenomorph_owner.actions_by_path[/datum/action/ability/xeno_action/endure]
	if(!endure_ability)
		return
...
/datum/mutation_upgrade/utility/safety_trap/proc/get_threshold(structure_count, include_initial = TRUE)

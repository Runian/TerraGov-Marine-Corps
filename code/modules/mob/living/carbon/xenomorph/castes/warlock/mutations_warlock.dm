...
/datum/mutation_upgrade/defense/cautious_mind/get_desc_for_alert(new_amount)
	if(!new_amount)
		return ..()
...
/datum/mutation_upgrade/defense/cautious_mind/on_gain()
	. = ..()
...
/datum/mutation_upgrade/defense/cautious_mind/on_loss()
	. = ..()
	var/datum/action/ability/activable/xeno/psychic_shield/shield_ability = xenomorph_owner.actions_by_path[/datum/action/ability/activable/xeno/psychic_shield]
	if(!shield_ability)
		return
...
/datum/mutation_upgrade/defense/cautious_mind/on_structure_update(previous_amount, new_amount)
	. = ..()
	var/datum/action/ability/activable/xeno/psychic_shield/shield_ability = xenomorph_owner.actions_by_path[/datum/action/ability/activable/xeno/psychic_shield]
	if(!shield_ability)
		return
...
/datum/mutation_upgrade/defense/cautious_mind/proc/get_multiplier(structure_count, include_initial = TRUE)
...
/datum/mutation_upgrade/offense/draining_blast/get_desc_for_alert(new_amount)
	if(!new_amount)
		return ..()
...
/datum/mutation_upgrade/offense/draining_blast/on_gain()
	. = ..()
...
/datum/mutation_upgrade/offense/draining_blast/on_loss()
	. = ..()
	var/datum/action/ability/activable/xeno/psy_blast/blast_ability = xenomorph_owner.actions_by_path[/datum/action/ability/activable/xeno/psy_blast]
	if(!blast_ability)
		return
...
/datum/mutation_upgrade/offense/draining_blast/on_structure_update(previous_amount, new_amount)
	. = ..()
	var/datum/action/ability/activable/xeno/psy_blast/blast_ability = xenomorph_owner.actions_by_path[/datum/action/ability/activable/xeno/psy_blast]
	if(!blast_ability)
		return
...
/datum/mutation_upgrade/offense/draining_blast/proc/get_multiplier(structure_count)
...
/datum/mutation_upgrade/utility/mobile_mind/get_desc_for_alert(new_amount)
	if(!new_amount)
		return ..()
...
/datum/mutation_upgrade/utility/mobile_mind/on_gain()
	. = ..()
	var/datum/action/ability/activable/xeno/psychic_shield/shield_ability = xenomorph_owner.actions_by_path[/datum/action/ability/activable/xeno/psychic_shield]
	if(!shield_ability)
		return
...
/datum/mutation_upgrade/utility/mobile_mind/on_loss()
	. = ..()
	var/datum/action/ability/activable/xeno/psychic_shield/shield_ability = xenomorph_owner.actions_by_path[/datum/action/ability/activable/xeno/psychic_shield]
	if(!shield_ability)
		return
...
/datum/mutation_upgrade/utility/mobile_mind/on_structure_update(previous_amount, new_amount)
	. = ..()
	var/datum/action/ability/activable/xeno/psychic_shield/shield_ability = xenomorph_owner.actions_by_path[/datum/action/ability/activable/xeno/psychic_shield]
	if(!shield_ability)
		return
...
/datum/mutation_upgrade/utility/mobile_mind/proc/get_movespeed(structure_count, include_initial = TRUE)

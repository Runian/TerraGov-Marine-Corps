...
/datum/mutation_upgrade/defense/gaseous_blood/get_desc_for_alert(new_amount)
	if(!new_amount)
		return ..()
...
/datum/mutation_upgrade/defense/gaseous_blood/proc/on_damage(datum/source, amount, list/amount_mod)
	SIGNAL_HANDLER
...
/datum/mutation_upgrade/defense/gaseous_blood/proc/get_cooldown(structure_count, include_initial = TRUE)
...
/datum/mutation_upgrade/offense/toxic_claws/get_desc_for_alert(new_amount)
	if(!new_amount)
		return ..()
...
/datum/mutation_upgrade/offense/toxic_claws/on_structure_update(previous_amount, new_amount)
	. = ..()
...
/datum/mutation_upgrade/offense/toxic_claws/proc/get_amount(structure_count, include_initial = TRUE)
...
/datum/mutation_upgrade/utility/toxic_spillage/get_desc_for_alert(new_amount)
	if(!new_amount)
		return ..()
...
/datum/mutation_upgrade/utility/toxic_spillage/on_gain()
	var/datum/action/ability/activable/xeno/neurotox_sting/sting_ability = xenomorph_owner.actions_by_path[/datum/action/ability/activable/xeno/neurotox_sting]
	if(!sting_ability)
		return
...
/datum/mutation_upgrade/utility/toxic_spillage/on_loss()
	var/datum/action/ability/activable/xeno/neurotox_sting/sting_ability = xenomorph_owner.actions_by_path[/datum/action/ability/activable/xeno/neurotox_sting]
	if(!sting_ability)
		return
	sting_ability.sting_amount /= injection_multiplier
...
/datum/mutation_upgrade/utility/toxic_spillage/on_structure_update(previous_amount, new_amount)
	. = ..()
	var/datum/action/ability/activable/xeno/neurotox_sting/sting_ability = xenomorph_owner.actions_by_path[/datum/action/ability/activable/xeno/neurotox_sting]
	if(!sting_ability)
		return
...
/datum/mutation_upgrade/utility/toxic_spillage/proc/get_range(structure_count, include_initial = TRUE)

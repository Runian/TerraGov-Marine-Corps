...
/datum/mutation_upgrade/defense/self_explosion/get_desc_for_alert(new_amount)
	if(!new_amount)
		return ..()
...
/datum/mutation_upgrade/defense/self_explosion/on_gain()
...
/datum/mutation_upgrade/defense/self_explosion/on_loss()
	var/datum/action/ability/activable/xeno/toss_grenade/grenade_ability = xenomorph_owner.actions_by_path[/datum/action/ability/activable/xeno/toss_grenade]
	if(!grenade_ability)
		return
	grenade_ability.use_state_flags &= ~ABILITY_TARGET_SELF
...
/datum/mutation_upgrade/defense/self_explosion/on_structure_update(previous_amount, new_amount)
	. = ..()
	var/datum/action/ability/activable/xeno/toss_grenade/grenade_ability = xenomorph_owner.actions_by_path[/datum/action/ability/activable/xeno/toss_grenade]
	if(!grenade_ability)
		return
...
/datum/mutation_upgrade/defense/self_explosion/proc/get_duration(structure_count, include_initial = TRUE)
...
/datum/mutation_upgrade/offense/blood_grenades/get_desc_for_alert(new_amount)
	if(!new_amount)
		return ..()
...
/datum/mutation_upgrade/offense/blood_grenades/on_gain()
	var/datum/action/ability/activable/xeno/toss_grenade/grenade_ability = xenomorph_owner.actions_by_path[/datum/action/ability/activable/xeno/toss_grenade]
	if(!grenade_ability)
		return
...
/datum/mutation_upgrade/offense/blood_grenades/on_loss()
	var/datum/action/ability/activable/xeno/toss_grenade/grenade_ability = xenomorph_owner.actions_by_path[/datum/action/ability/activable/xeno/toss_grenade]
	if(!grenade_ability)
		return
	grenade_ability.health_loss_percentage_per_grenade -= get_percentage(0)
...
/datum/mutation_upgrade/offense/blood_grenades/on_structure_update(previous_amount, new_amount)
	. = ..()
	var/datum/action/ability/activable/xeno/toss_grenade/grenade_ability = xenomorph_owner.actions_by_path[/datum/action/ability/activable/xeno/toss_grenade]
	if(!grenade_ability)
		return
...
/datum/mutation_upgrade/offense/blood_grenades/proc/get_percentage(structure_count, include_initial = TRUE)
...
/datum/mutation_upgrade/utility/repurposed_capacity/get_desc_for_alert(new_amount)
	if(!new_amount)
		return ..()
...
/datum/mutation_upgrade/utility/repurposed_capacity/on_structure_update(previous_amount, new_amount)
	. = ..()
...
/datum/mutation_upgrade/utility/repurposed_capacity/proc/get_capacity(structure_count)
...
/datum/mutation_upgrade/utility/repurposed_capacity/proc/get_recharge(structure_count)

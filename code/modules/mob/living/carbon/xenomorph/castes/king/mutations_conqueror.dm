...
/datum/mutation_upgrade/defense/healing_jab/get_desc_for_alert(new_amount)
	if(!new_amount)
		return ..()
...
/datum/mutation_upgrade/defense/healing_jab/on_gain()
	. = ..()
...
/datum/mutation_upgrade/defense/healing_jab/on_loss()
	. = ..()
	var/datum/action/ability/activable/xeno/conqueror_will/will_ability = xenomorph_owner.actions_by_path[/datum/action/ability/activable/xeno/conqueror_will]
	if(!will_ability)
		return
...
/datum/mutation_upgrade/defense/healing_jab/on_structure_update(previous_amount, new_amount)
	. = ..()
	var/datum/action/ability/activable/xeno/conqueror_will/will_ability = xenomorph_owner.actions_by_path[/datum/action/ability/activable/xeno/conqueror_will]
	if(!will_ability)
		return
...
/datum/mutation_upgrade/defense/healing_jab/proc/get_percentage(structure_count)
...
/datum/mutation_upgrade/offense/telefrag/on_loss()
	. = ..()
	var/datum/action/ability/activable/xeno/conqueror_domination/domination_ability = xenomorph_owner.actions_by_path[/datum/action/ability/activable/xeno/conqueror_domination]
	if(!domination_ability)
		return
...
/datum/mutation_upgrade/offense/telefrag/on_structure_update(previous_amount, new_amount)
	. = ..()
	var/datum/action/ability/activable/xeno/conqueror_domination/domination_ability = xenomorph_owner.actions_by_path[/datum/action/ability/activable/xeno/conqueror_domination]
	if(!domination_ability)
		return
...
/datum/mutation_upgrade/offense/telefrag/proc/get_duration(structure_count, include_initial = TRUE)
...
/datum/mutation_upgrade/utility/dasher/get_desc_for_alert(new_amount)
	if(!new_amount)
		return ..()
...
/datum/mutation_upgrade/utility/dasher/on_gain()
	. = ..()
...
/datum/mutation_upgrade/utility/dasher/on_loss()
	. = ..()
	var/datum/action/ability/xeno_action/conqueror_dash/dash_ability = xenomorph_owner.actions_by_path[/datum/action/ability/xeno_action/conqueror_dash]
	if(!dash_ability)
		return
...
/datum/mutation_upgrade/utility/dasher/on_structure_update(previous_amount, new_amount)
	. = ..()
	var/datum/action/ability/xeno_action/conqueror_dash/dash_ability = xenomorph_owner.actions_by_path[/datum/action/ability/xeno_action/conqueror_dash]
	if(!dash_ability)
		return
...
/datum/mutation_upgrade/utility/dasher/proc/get_dashes(structure_count)
